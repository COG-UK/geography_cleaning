...
def main(metadata, file_date):
    ...
    with open(metadata) as f:
        ...
        for l in data:
            ...
            elif l['utla'] == "OUTER LONDON|INNER LONDON" or l['utla'] == "INNER LONDON|OUTER LONDON":
                utla = "GREATER LONDON"
                utla_to_region[utla] = l['NUTS1']
                utla_to_code[utla] = l['utla_code']
        ...
        for l in data:
            if l['sample_date'] != "":
                ...
                if l['scorpio_call'] == "Delta (B.1.617.2-like)":
                    utla_delta[date].append(utla)
                else:
                    utla_other[date].append(utla)
                    
                utla_all[date].append(utla)
